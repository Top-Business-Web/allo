...
<div class="contact-page-google-map">
    <div class="container">
        <iframe src="{{ $setting->location_url }}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
<style>
    .blackColor {
                        ...
                        <div class="contact-page_form">
                            <form class="contactForm" id="contactForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="comment-form_input-box">
                                            <input class="blackColor" type="email" placeholder="{{ trans('site.email') }}" name="email">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="comment-form_input-box">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="comment-form_input-box">
                                            <input class="blackColor" type="text" placeholder="{{ trans('site.subject') }}" name="subject">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="comment-form_input-box">
                                            <textarea class="blackColor" name="message" placeholder="{{ trans('site.write_a_message') }}"></textarea>
                                        </div>
                                        <button type="button" id="career-btn" class="main-btn comment-form_btn">{{ trans('site.send_a_message') }}
                                        </button>
                                    </div>
                                    <div class="col-12">
